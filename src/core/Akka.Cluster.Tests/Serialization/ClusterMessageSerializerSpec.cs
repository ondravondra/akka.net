...
namespace Akka.Cluster.Tests.Serialization
{
    public class ClusterMessageSerializerSpec : AkkaSpec
    {
        ...
        private static readonly Member c1 = TestMember.Create(new Address("akka.tcp", "sys", "c", 2552), MemberStatus.Leaving, ImmutableHashSet.Create<string>("r2"));
        private static readonly Member d1 = TestMember.Create(new Address("akka.tcp", "sys", "d", 2552), MemberStatus.Exiting, ImmutableHashSet.Create<string>("r1", "r2"));
