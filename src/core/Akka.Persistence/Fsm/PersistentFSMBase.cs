...
namespace Akka.Persistence.Fsm
{
    ...
    public abstract class PersistentFSMBase<TState, TData, TEvent> : PersistentActor, IListeners
    {
        ...
        private string GetSourceString(object source)
        {
            ...
            var timer = source as FSMBase.Timer;
            if (timer != null)
        ...
        {
            var timeoutMarker = message as FSMBase.TimeoutMarker;
            ...
            var timer = message as FSMBase.Timer;
            if (timer != null)
            {
            ...
            var subscribeTransitionCallBack = message as FSMBase.SubscribeTransitionCallBack;
            ...
            var unsubscribeTransitionCallBack = message as FSMBase.UnsubscribeTransitionCallBack;
        ...
        {
            var failure = reason as FSMBase.Failure;
            if (failure != null)
            {
